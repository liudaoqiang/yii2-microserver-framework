...
define("SUITE_KEY", "ding5c66fc540b93409235c2f4657eb6378f");
define("CREATE_SUITE_KEY", "ding5c66fc540b93409235c2f4657eb6378f");
...
//    org_remove ： 企业被解散
        ...
        Log::e("STATUS: bpms_task_change");
    } elseif ("bpms_instance_change" == $eventType) {
        Log::e("STATUS: bpms_instance_change");
    } else {
        //should never happen
    }
    ...
    if ($errCode == 0) {
        ...
        Log::i("RESPONSE_DONE: " . $encryptMsg);
    } else {
